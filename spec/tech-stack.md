...
| Cloud adapter | Google Drive appDataFolder or Dropbox App Folder plus Cloudflare Worker control plane | One selected direct optional provider; Worker OAuth/token, hosted-service, push, and metrics boundary |
