...
export const MCP_TOOL_DEFINITIONS: McpToolDefinition[] = [
    ...
    },
    {
        ...
        scopes: ['read', 'write'],
        inputSchema: {
            type: 'object', properties: { invoiceId: optionalString, confirmDelete: optionalBoolean },
            required: ['invoiceId', 'confirmDelete'], additionalProperties: false,
        },
    },
    {
        ...
        scopes: ['read', 'write'],
        inputSchema: {
            type: 'object', properties: { invoiceId: optionalString, confirmRefresh: optionalBoolean, exchangeRates: { type: ['object', 'null'] } },
            required: ['invoiceId', 'confirmRefresh'], additionalProperties: false,
        },
    },
    {
