...
export const AGENT_COMMAND_REGISTRY: Registry = {
    ...
    cascade_delete_project: {
        ...
        description: 'Delete a project and related non-billed tasks, entries, timers, expenses, recurring templates, and planner attachments after preview matching, confirmation, and browser approval.',
        scopes: ['write'],
    ...
    delete_project: {
        name: 'delete_project',
        description: 'Delete one unreferenced project after explicit command confirmation and browser approval.',
        scopes: ['write'],
        requiresApproval: true,
    ...
    list_clients: {
        name: 'list_clients',
        description: 'List active clients visible to the current TaskTime app session.',
        scopes: ['read'],
    ...
    cascade_delete_client: {
        ...
        description: 'Delete a client and either convert linked projects to personal or delete related non-billed project data after preview matching, confirmation, and browser approval.',
        scopes: ['write'],
        requiresApproval: true,
    ...
    delete_client: {
        name: 'delete_client',
        description: 'Delete one unreferenced client after explicit command confirmation and browser approval.',
        scopes: ['write'],
        requiresApproval: true,
    ...
    delete_business_info: {
        ...
        description: 'Delete one unreferenced business profile after explicit command confirmation and browser approval.',
        scopes: ['write'],
        requiresApproval: true,
    ...
    delete_business_brand_asset: {
        ...
        description: 'Delete one unreferenced business logo brand asset after explicit command confirmation and browser approval.',
        scopes: ['write'],
        requiresApproval: true,
    ...
    delete_payment_method: {
        ...
        description: 'Delete one unreferenced payment method after explicit command confirmation and browser approval.',
        scopes: ['write'],
        requiresApproval: true,
    ...
    delete_invoice_template: {
        ...
        description: 'Delete one unreferenced invoice template after explicit command confirmation and browser approval.',
        scopes: ['write'],
        requiresApproval: true,
    ...
    delete_email_template: {
        ...
        description: 'Delete one invoice or quote email template after explicit command confirmation and browser approval.',
        scopes: ['write'],
        requiresApproval: true,
    ...
    delete_expense_category: {
        ...
        description: 'Delete one unreferenced expense category after explicit command confirmation and browser approval.',
        scopes: ['write'],
        requiresApproval: true,
    ...
    get_preferences: {
        ...
        description: 'Return validated TaskTime user preferences. Sync/backup control state is readable, but mutation is handled by explicit sync-control commands later.',
        scopes: ['read'],
    ...
    unarchive_task: {
        name: 'unarchive_task',
        description: 'Restore an archived task using existing TaskTime unarchive behavior.',
        scopes: ['write'],
    ...
    cascade_delete_task: {
        ...
        description: 'Delete a task, descendant tasks, related active time entries, matching timers, and planner attachments after preview matching, confirmation, and browser approval.',
        scopes: ['write'],
        requiresApproval: true,
    ...
    delete_task: {
        name: 'delete_task',
        description: 'Delete one unreferenced active or archived task after explicit command confirmation and browser approval.',
        scopes: ['write'],
        requiresApproval: true,
    ...
    delete_time_entry: {
        ...
        description: 'Delete one active unbilled time entry after explicit command confirmation and browser approval.',
        scopes: ['write'],
        requiresApproval: true,
    ...
    delete_expense: {
        name: 'delete_expense',
        description: 'Delete one active unbilled and unclaimed expense after explicit command confirmation and browser approval.',
        scopes: ['write'],
        requiresApproval: true,
    ...
    delete_expense_recurrence: {
        ...
        description: 'Delete one recurring expense template after explicit command confirmation and browser approval without deleting generated expenses.',
        scopes: ['write'],
        requiresApproval: true,
    ...
    mark_expenses_tax_claimed: {
        ...
        description: 'Mark selected expenses as tax claimed against an existing tax return period after confirmation and browser approval.',
        scopes: ['write'],
        requiresApproval: true,
    ...
    mark_expenses_tax_unclaimed: {
        ...
        description: 'Clear tax claim status and period links from selected expenses after confirmation and browser approval.',
        scopes: ['write'],
        requiresApproval: true,
    ...
    list_drive_backups: {
        ...
        description: 'List TaskTime JSON backup snapshots currently available in Google Drive without returning backup contents.',
        scopes: ['read', 'export'],
        handler: (context) => listDriveBackupsCommand(context),
    },
    create_drive_backup: {
        name: 'create_drive_backup',
        description: 'Create a TaskTime JSON backup snapshot in Google Drive using the existing backup manager.',
        scopes: ['read', 'export'],
    ...
    preview_backup_import_json: {
        ...
        description: 'Validate a TaskTime backup JSON payload and return import metadata without mutating current data.',
        scopes: ['read'],
        handler: previewBackupImportJsonCommand,
    },
    restore_backup_json: {
        name: 'restore_backup_json',
        description: 'Replace current local TaskTime data with a validated backup JSON payload after explicit confirmation and browser approval.',
    ...
    restore_drive_backup: {
        ...
        description: 'Replace current local TaskTime data from a selected Google Drive backup after explicit confirmation and browser approval.',
        scopes: ['read', 'write', 'export'],
        requiresApproval: true,
    ...
    delete_all_account_data: {
        ...
        description: 'Delete all local TaskTime data and, when Drive is connected, wipe Drive sync data and backups after explicit confirmation and browser approval.',
        scopes: ['read', 'write', 'export'],
        requiresApproval: true,
    ...
    open_reports_view: {
        ...
        description: 'Open the reports route in the paired TaskTime app session.',
        scopes: ['navigation'],
