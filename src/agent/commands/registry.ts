...
export const AGENT_COMMAND_REGISTRY: Registry = {
    ...
    cascade_delete_project: {
        ...
        description: 'Delete a project and related non-billed tasks, entries, timers, expenses, recurring templates, and planner attachments after preview matching, confirmation, and TaskTime approval.',
        scopes: ['write'],
    ...
    cascade_delete_client: {
        ...
        description: 'Delete a client and either convert linked projects to personal or delete related non-billed project data after preview matching, confirmation, and TaskTime approval.',
        scopes: ['write'],
        requiresApproval: true,
    ...
    delete_business_info: {
        ...
        description: 'Delete one unreferenced business profile after explicit command confirmation and TaskTime approval.',
        scopes: ['write'],
        requiresApproval: true,
    ...
    delete_business_brand_asset: {
        ...
        description: 'Delete one unreferenced business logo brand asset after explicit command confirmation and TaskTime approval.',
        scopes: ['write'],
        requiresApproval: true,
    ...
    delete_payment_method: {
        ...
        description: 'Delete one unreferenced payment method after explicit command confirmation and TaskTime approval.',
        scopes: ['write'],
        requiresApproval: true,
    ...
    delete_invoice_template: {
        ...
        description: 'Delete one unreferenced invoice template after explicit command confirmation and TaskTime approval.',
        scopes: ['write'],
        requiresApproval: true,
    ...
    delete_expense_category: {
        ...
        description: 'Delete one unreferenced expense category after explicit command confirmation and TaskTime approval.',
        scopes: ['write'],
        requiresApproval: true,
    ...
    cascade_delete_task: {
        ...
        description: 'Delete a task, descendant tasks, related active time entries, matching timers, and planner attachments after preview matching, confirmation, and TaskTime approval.',
        scopes: ['write'],
        requiresApproval: true,
    ...
    clear_timer: {
        name: 'clear_timer',
        description: 'Discard an active timer without creating a time entry after explicit command confirmation and TaskTime approval.',
        scopes: ['write'],
        requiresApproval: true,
    ...
    delete_time_entry: {
        ...
        description: 'Delete one active unbilled time entry after explicit command confirmation and TaskTime approval.',
        scopes: ['write'],
        requiresApproval: true,
    ...
    delete_expense: {
        name: 'delete_expense',
        description: 'Delete one active unbilled and unclaimed expense after explicit command confirmation and TaskTime approval.',
        scopes: ['write'],
        requiresApproval: true,
    ...
    mark_expenses_tax_claimed: {
        ...
        description: 'Mark selected expenses as tax claimed against an existing tax return period after confirmation and TaskTime approval.',
        scopes: ['write'],
        requiresApproval: true,
    ...
    mark_expenses_tax_unclaimed: {
        ...
        description: 'Clear tax claim status and period links from selected expenses after confirmation and TaskTime approval.',
        scopes: ['write'],
        requiresApproval: true,
    ...
    restore_backup_json: {
        ...
        description: 'Replace current local TaskTime data with a validated backup JSON payload after explicit confirmation and TaskTime approval.',
    ...
    restore_drive_backup: {
        ...
        description: 'Replace current local TaskTime data from a selected Google Drive backup after explicit confirmation and TaskTime approval.',
        scopes: ['read', 'write', 'export'],
        requiresApproval: true,
    ...
    delete_all_account_data: {
        ...
        description: 'Delete all local TaskTime data and, when Drive is connected, wipe Drive sync data and backups after explicit confirmation and TaskTime approval.',
        scopes: ['read', 'write', 'export'],
        requiresApproval: true,
