        ...
        editorProps: {
            attributes: {
                class: cn(
                    ...
                    '[&_.task-item>label>input]:mt-0 [&_.task-item>label>input]:h-4 [&_.task-item>label>input]:w-4 [&_.task-item>label>input]:cursor-pointer [&_.task-item>label>input]:accent-primary',
                    ...
                    '[&_[data-type="taskItem"]>label>input]:mt-0 [&_[data-type="taskItem"]>label>input]:h-4 [&_[data-type="taskItem"]>label>input]:w-4 [&_[data-type="taskItem"]>label>input]:cursor-pointer [&_[data-type="taskItem"]>label>input]:accent-primary',
