                ...
                <div className="p-4 space-y-4">
                    ...
                    <div>
                        ...
                        <div className="flex space-x-2">
                            ...
                            <input
                                ...
                                className="flex-1 border border-border rounded-md px-2 py-1 text-base text-foreground sensitive-data md:text-sm"
                    ...
                    <div>
                        ...
                        <input
                            ...
                            className="w-full border border-border rounded-md px-2 py-1 text-base text-foreground sensitive-data md:text-sm"
                            placeholder="0.00"
                        />
                    </div>
                            ...
                            <div className="grid grid-cols-2 gap-2">
                                ...
                                <div>
                                    <input
                                        ...
                                        className="w-full border border-border rounded-md px-2 py-1 text-base text-foreground md:text-sm"
                                        placeholder="Rate %"
                                    />
                                </div>
                            </div>
