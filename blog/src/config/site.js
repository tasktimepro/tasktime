...
export const SITE_DESCRIPTION = 'Free, open-source, local-first work management for freelancers, covering tasks, timers, expenses, invoices, and reports. No TaskTime Pro account or cloud sync is required for core use.';
