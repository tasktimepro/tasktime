...
export function GET() {
    ...
    const body = [
        '# TaskTime Agent Skill',
        '',
        `Updated: ${AGENT_DOCS_LAST_UPDATED}`,
        '',
        '## Purpose',
        '',
        'Use this skill when a user asks an AI agent to work with TaskTime: local-first task management, time tracking, expenses, reports, invoices, project quotes, planner notes, backups, sync settings, or account data.',
        '',
        '## Public References',
        '',
        ...
        '- OpenClaw bundle package: `@tasktime/openclaw`',
        '- Bridge binary package: `@tasktime/agent-bridge`',
        '',
        '## Operating Rules',
        '',
        '- Prefer TaskTime MCP tools over browser UI automation.',
        '- Treat TaskTime as local-first customer data. Do not ask users to reset browser data or Drive state as a normal fix.',
        '- Launch `tasktime-agent-bridge --app-url <TaskTime URL>` when local MCP access is needed.',
        '- Require a running paired TaskTime browser app session before reading or mutating local TaskTime data.',
        ...
        '- Use a valid exact-input TaskTime approval token or browser-visible approval for sensitive actions.',
