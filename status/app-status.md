...
- [ ] Deliver the approved one-phase provider-neutral cloud-sync and Dropbox plan in the dependency order recorded in `status/cloud-sync-provider-expansion.md`; implementation has not started, and the current Google flow remains the production contract.
